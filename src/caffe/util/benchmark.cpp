...
float Timer::MicroSeconds() {
  ...
  if (Caffe::mode() == Caffe::GPU) {
    ...
    elapsed_microseconds_ =
        std::chrono::duration_cast<std::chrono::microseconds>(this->stop_cpu_ - this->start_cpu_).count();
  }
...
float Timer::MilliSeconds() {
  ...
  if (Caffe::mode() == Caffe::GPU) {
    ...
    elapsed_milliseconds_ =
      std::chrono::duration_cast<std::chrono::milliseconds>(this->stop_cpu_ - this->start_cpu_).count();
  }
