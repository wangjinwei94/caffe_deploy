...
static const int max_path=280;
static inline void MakeTempFilename(string* temp_filename) {
  int rand_name=caffe_rng_rand()%100000000;
  char buf[max_path];
  sprintf(buf, "%0d", rand_name);
  *temp_filename=string(buf);
}
